...
def get_paths(run_date, taxi_type, run_id):
    ...
    output_file = f's3://nyc-duration-prediction-jeff/taxi_type={taxi_type}/year={year:04d}/month={month:02d}/{run_id}.parquet'
...
def run():
    ...
    run_id = sys.argv[4] # '9099cf72ff2d41ec82f98bb5a9f7d95e'
