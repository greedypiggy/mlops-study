...
#     mlflow.set_tag("developer", "jeff.go")
...
def train_best_model(train, valid, y_val):
    with mlflow.start_run():    
        best_params = {
            'learning_rate': 0.20097105432762608,
            'max_depth': 18,
            'min_child_weight': 1.1224113791381114,
            'objective': 'reg:linear',
            'reg_alpha': 0.018720109961773625,
            'reg_lambda': 0.0025784880241511814,
            'seed': 42
        }
